...
- [x] **Deformer → automatic** (2026-06-25). Authoring panel leaves the Salon; range becomes morphology-derived. Wiring mapped (§4).
...
- [x] **Sequencing** (2026-06-25): the **WYSIWYG plumbing leads** (autosave + fold-regenerate-into-bake + render-the-published-artifact-everywhere) so the plates render the artifact that actually ships; the plate-rack + part-base procurement + the deformer-table cut + leaf near-tier follow on a trustworthy substrate.
</content>

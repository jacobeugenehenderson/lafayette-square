...
// Mackay Place round cul-de-sac at [45,-483]; Vail Place [295,85]
writeFileSync(new URL('./pwide.svg',import.meta.url), view(600,-700,500,500,0.6))
console.log('done')
console.log('LS tile build time check done')

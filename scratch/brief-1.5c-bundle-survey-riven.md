...
- **Decomposed chassis emitted (new):** 18
- **Bundle-debris items skipped (no WOOD in subtree):** 149
- **Bundle items skipped (ambiguous in subtree):** 11
- **Single-tree chassis emitted via Whittle path (byte-identical to Brief 0):** 133
- **Single-tree skipped-ambiguous:** 83; **skipped-no-wood:** 111; **errored:** 0
...
| gleditsia_triacanthos/skeleton-1-lod0.glb | 10 | `honey_locust_a_bark3` | `bark2` (W0/L1/A0); `fuzz2` (W0/L1/A0); `leaff2` (W0/L1/A0); `stem2` (W0/L1/A0); `fuzz3` (W0/L1/A0); `leaff3` (W0/L1/A0); `stem3` (W0/L1/A0) | `seed2`; `seed3` |
| gleditsia_triacanthos/skeleton-2-lod0.glb | 10 | `honey_locust_b_bark1`, `honey_locust_b_bark3` | `fuzz1` (W0/L1/A0); `leaff1` (W0/L1/A0); `stem1` (W0/L1/A0); `fuzz3` (W0/L1/A0); `leaff3` (W0/L1/A0); `stem3` (W0/L1/A0) | `seed1`; `seed3` |
| gleditsia_triacanthos/skeleton-3-lod0.glb | 10 | `honey_locust_c_bark1` | `fuzz1` (W0/L1/A0); `leaff1` (W0/L1/A0); `stem1` (W0/L1/A0); `bark2` (W0/L1/A0); `fuzz2` (W0/L1/A0); `leaff2` (W0/L1/A0); `stem2` (W0/L1/A0) | `seed1`; `seed2` |
| platanus_acerifolia/skeleton-13-lod0.glb | 2 | — | `WhiteBirchBark_G2` (W0/L1/A0) | `PT_G2` |
| platanus_acerifolia/skeleton-14-lod0.glb | 2 | — | `WhiteBirchBark_F2` (W0/L1/A0) | `PT_F2` |
| populus_alba_fall/skeleton-1-lod0.glb | 12 | — | `Bark_Populier_Green_02.001` (W0/L0/A0); `L_P_Populier_Green_02.001` (W0/L1/A0); `Bark_Populier_Green_02.002` (W0/L0/A0); `L_P_Populier_Green_02.002` (W0/L1/A0); `Bark_Populier_Fall_02` (W0/L0/A0); `L_P_Populier_Fall_02` (W0/L0/A0); `Bark_Populier_Fall_02.001` (W0/L1/A0); `L_P_Populier_Fall_02.001` (W0/L1/A0); `Bark_Populier_Fall_02.002` (W0/L0/A0); `L_P_Populier_Fall_02.002` (W0/L1/A0); `Bark_Populier_Fall_02.003` (W0/L0/A0); `L_P_Populier_Fall_02.003` (W0/L0/A0) | — |
...
| populus_alba_fall/skeleton-5-lod0.glb | 12 | — | `Bark_Populier_Green_02` (W0/L1/A0); `L_P_Populier_Green_02` (W0/L1/A0); `Bark_Populier_Green_02.001` (W0/L0/A0); `L_P_Populier_Green_02.001` (W0/L1/A0); `Bark_Populier_Green_02.002` (W0/L0/A0); `L_P_Populier_Green_02.002` (W0/L1/A0); `Bark_Populier_Fall_02` (W0/L0/A0); `L_P_Populier_Fall_02` (W0/L0/A0); `Bark_Populier_Fall_02.002` (W0/L0/A0); `L_P_Populier_Fall_02.002` (W0/L1/A0); `Bark_Populier_Fall_02.003` (W0/L0/A0); `L_P_Populier_Fall_02.003` (W0/L0/A0) | — |
...
| populus_canescens/skeleton-1-lod0.glb | 6 | — | `leaf22` (W0/L1/A0); `Trunk22` (W0/L1/A0); `leaf33` (W0/L1/A0); `Trunk33` (W0/L1/A0); `leaf44` (W0/L1/A0); `Trunk44` (W0/L1/A0) | — |
| populus_canescens/skeleton-2-lod0.glb | 6 | — | `leaf11` (W0/L1/A0); `Trunk11` (W0/L1/A0); `leaf33` (W0/L1/A0); `Trunk33` (W0/L1/A0); `leaf44` (W0/L1/A0); `Trunk44` (W0/L1/A0) | — |
| populus_canescens/skeleton-3-lod0.glb | 6 | — | `leaf11` (W0/L1/A0); `Trunk11` (W0/L1/A0); `leaf22` (W0/L1/A0); `Trunk22` (W0/L1/A0); `leaf44` (W0/L1/A0); `Trunk44` (W0/L1/A0) | — |
| populus_canescens/skeleton-4-lod0.glb | 6 | — | `leaf11` (W0/L1/A0); `Trunk11` (W0/L1/A0); `leaf22` (W0/L1/A0); `Trunk22` (W0/L1/A0); `leaf33` (W0/L1/A0); `Trunk33` (W0/L1/A0) | — |
...
- `gleditsia_triacanthos` ("Honey Locust") — 4 bundle-decomposed chassis

**Species still recommended for operator review** (no clean chassis even after bundle decomposition):

- `abies_concolor` ("White Fir") — no clean output (mix of ambiguous / no-wood / errored)
- `acer_saccharum_multistem` ("Sugar Maple (multistem)") — no clean output (mix of ambiguous / no-wood / errored)
- `alaskan_cedar_2` ("Alaskan Cedar (variant)") — no clean output (mix of ambiguous / no-wood / errored)
- `betula_pendula` ("Common Birch") — still no usable chassis (all variants no-wood or bundle-debris)
- `blue_spruce` ("Blue Spruce") — no clean output (mix of ambiguous / no-wood / errored)
- `blue_spruce_winter` ("Blue Spruce (winter)") — still no usable chassis (all variants no-wood or bundle-debris)
- `callitropsis_nootkatensis` ("Alaskan Cedar") — still no usable chassis (all variants no-wood or bundle-debris)
...
- `generic_tree_3` ("Bonsai") — still no usable chassis (all variants no-wood or bundle-debris)
...
- `nyssa_sylvatica` ("Black Gum") — no clean output (mix of ambiguous / no-wood / errored)
- `picea_abies` ("Norway Spruce") — no clean output (mix of ambiguous / no-wood / errored)
- `pine_corona` ("Pine (Corona)") — still no usable chassis (all variants no-wood or bundle-debris)
- `pinus_sylvestris` ("Scots Pine") — no clean output (mix of ambiguous / no-wood / errored)
- `populus_canescens` ("Gray Poplar") — still no usable chassis (all variants no-wood or bundle-debris)
...
- `quercus_winter_fall` ("Oak (winter/fall)") — no clean output (mix of ambiguous / no-wood / errored)
- `salix_alba` ("White Willow") — still no usable chassis (all variants no-wood or bundle-debris)
...
- `tree_hz` ("HZ Tree") — still no usable chassis (all variants no-wood or bundle-debris)
...
- `willow_stylized` ("Stylized Willow") — still no usable chassis (all variants no-wood or bundle-debris)

## 6. Brief 1.5b curation-file cross-check

_`public/trees/_chassis/_chassis-curation.json` not present at Riven re-run time — Brief 1.5b may not have shipped yet. No cross-check performed; future re-runs will validate emitted chassis filenames against the curation file._
...
| populus_alba_fall/skeleton-1-lod0.glb | `Bark_Populier_Fall_02.001` | 1 | Bark_Populier_Green_02_Mat.001 |
...
| populus_alba_fall/skeleton-5-lod0.glb | `Bark_Populier_Green_02` | 1 | Bark_Populier_Green_02_Mat |
...
| populus_canescens/skeleton-1-lod0.glb | `Trunk22` | 1 | Trunk22_Mat |
| populus_canescens/skeleton-1-lod0.glb | `leaf33` | 1 | leaf22_Mat |
| populus_canescens/skeleton-1-lod0.glb | `Trunk33` | 1 | Trunk33_Mat |
| populus_canescens/skeleton-1-lod0.glb | `leaf44` | 1 | leaf22_Mat |
| populus_canescens/skeleton-1-lod0.glb | `Trunk44` | 1 | Trunk33_Mat |
| populus_canescens/skeleton-2-lod0.glb | `leaf11` | 1 | leaf11_Mat |
| populus_canescens/skeleton-2-lod0.glb | `Trunk11` | 1 | Trunk11_Mat |
| populus_canescens/skeleton-2-lod0.glb | `leaf33` | 1 | leaf11_Mat |
| populus_canescens/skeleton-2-lod0.glb | `Trunk33` | 1 | Trunk33_Mat |
| populus_canescens/skeleton-2-lod0.glb | `leaf44` | 1 | leaf11_Mat |
| populus_canescens/skeleton-2-lod0.glb | `Trunk44` | 1 | Trunk33_Mat |
| populus_canescens/skeleton-3-lod0.glb | `leaf11` | 1 | leaf11_Mat |
| populus_canescens/skeleton-3-lod0.glb | `Trunk11` | 1 | Trunk11_Mat |
| populus_canescens/skeleton-3-lod0.glb | `leaf22` | 1 | leaf11_Mat |
| populus_canescens/skeleton-3-lod0.glb | `Trunk22` | 1 | Trunk11_Mat |
| populus_canescens/skeleton-3-lod0.glb | `leaf44` | 1 | leaf11_Mat |
| populus_canescens/skeleton-3-lod0.glb | `Trunk44` | 1 | Trunk44_Mat |
| populus_canescens/skeleton-4-lod0.glb | `leaf11` | 1 | leaf11_Mat |
| populus_canescens/skeleton-4-lod0.glb | `Trunk11` | 1 | Trunk11_Mat |
| populus_canescens/skeleton-4-lod0.glb | `leaf22` | 1 | leaf11_Mat |
| populus_canescens/skeleton-4-lod0.glb | `Trunk22` | 1 | Trunk11_Mat |
| populus_canescens/skeleton-4-lod0.glb | `leaf33` | 1 | leaf11_Mat |
| populus_canescens/skeleton-4-lod0.glb | `Trunk33` | 1 | Trunk33_Mat |
...
| gleditsia_triacanthos/skeleton-1-lod0.glb | `bark2` | bundle-debris | 0 / 1 / 0 | — | — |
...
| gleditsia_triacanthos/skeleton-1-lod0.glb | `stem2` | bundle-debris | 0 / 1 / 0 | — | — |
...
| gleditsia_triacanthos/skeleton-1-lod0.glb | `stem3` | bundle-debris | 0 / 1 / 0 | — | — |
...
| gleditsia_triacanthos/skeleton-2-lod0.glb | `stem1` | bundle-debris | 0 / 1 / 0 | — | — |
...
| gleditsia_triacanthos/skeleton-2-lod0.glb | `stem3` | bundle-debris | 0 / 1 / 0 | — | — |
...
| gleditsia_triacanthos/skeleton-3-lod0.glb | `stem1` | bundle-debris | 0 / 1 / 0 | — | — |
| gleditsia_triacanthos/skeleton-3-lod0.glb | `bark2` | bundle-debris | 0 / 1 / 0 | — | — |
...
| gleditsia_triacanthos/skeleton-3-lod0.glb | `stem2` | bundle-debris | 0 / 1 / 0 | — | — |
| platanus_acerifolia/skeleton-13-lod0.glb | `PT_G2` | bundle-skipped-ambiguous | 0 / 0 / 1 | — | — |
| platanus_acerifolia/skeleton-13-lod0.glb | `WhiteBirchBark_G2` | bundle-debris | 0 / 1 / 0 | — | — |
| platanus_acerifolia/skeleton-14-lod0.glb | `PT_F2` | bundle-skipped-ambiguous | 0 / 0 / 1 | — | — |
| platanus_acerifolia/skeleton-14-lod0.glb | `WhiteBirchBark_F2` | bundle-debris | 0 / 1 / 0 | — | — |
...
| populus_alba_fall/skeleton-1-lod0.glb | `Bark_Populier_Fall_02.001` | bundle-debris | 0 / 1 / 0 | — | — |
...
| populus_alba_fall/skeleton-5-lod0.glb | `Bark_Populier_Green_02` | bundle-debris | 0 / 1 / 0 | — | — |
...
| populus_canescens/skeleton-1-lod0.glb | `Trunk22` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-1-lod0.glb | `leaf33` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-1-lod0.glb | `Trunk33` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-1-lod0.glb | `leaf44` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-1-lod0.glb | `Trunk44` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-2-lod0.glb | `leaf11` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-2-lod0.glb | `Trunk11` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-2-lod0.glb | `leaf33` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-2-lod0.glb | `Trunk33` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-2-lod0.glb | `leaf44` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-2-lod0.glb | `Trunk44` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-3-lod0.glb | `leaf11` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-3-lod0.glb | `Trunk11` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-3-lod0.glb | `leaf22` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-3-lod0.glb | `Trunk22` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-3-lod0.glb | `leaf44` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-3-lod0.glb | `Trunk44` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-4-lod0.glb | `leaf11` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-4-lod0.glb | `Trunk11` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-4-lod0.glb | `leaf22` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-4-lod0.glb | `Trunk22` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-4-lod0.glb | `leaf33` | bundle-debris | 0 / 1 / 0 | — | — |
| populus_canescens/skeleton-4-lod0.glb | `Trunk33` | bundle-debris | 0 / 1 / 0 | — | — |

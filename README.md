...
| **Dead-ends** (cul-de-sac · stub · spike) | `OSM-FORENSICS §1` · `SECTION.md §6` (cap *fill*) | render **clean WOVEN** with their authored cap; the pendant-prune was reverted (asphalt is tile-sourced → pruning deletes the road) |

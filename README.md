...
| **Dead-ends** (cul-de-sac · stub · spike) | **`SECTION.md §6.3`** (the cap is an end COUPLER — LANDED 2026-07-22, + the scoreboard) · `OSM-FORENSICS §1` | render **clean WOVEN** with their authored cap; **the ribbon folds, not the chain** (one fe folded on itself, chopped at the shoulders) and **the bulb has no halves**. 3 defects fixed at source (cap slope · leg flip · width collapse); legs responding 56→93/100; 10 asymmetric caps ACCEPTED. ⛔ The **MOUTH** is a **co-claim, not a gap** (~15 m²/mouth, 2 layers) → an identity defect, live in `cartograph/_archive/BRIEF-polygon-asks-the-stamp-2026-07-30.md`; never FILL-patch it. The pendant-prune was reverted (asphalt is tile-sourced → pruning deletes the road) |

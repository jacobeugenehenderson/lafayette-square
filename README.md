...
| **survey** (SHAPE tool — *no ped depth*) | **`SURVEY.md`** (the keystone — tile construction + authoring + the wall) · `PIPELINE.md §survey` + `ARCHITECTURE.md §2.1` | `FEATURES.md §Toolbar` · `SECTION-CENSUS.md` (SHAPE/FILL split) |

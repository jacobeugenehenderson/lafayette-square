...
Księży Młyn, Łódź — installation #3, the first non-US pour and a one-off
internationalisation test alongside `centrum`. Defunct. Its 63 tracked files were
removed at HEAD when it was retired.

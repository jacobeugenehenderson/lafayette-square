...
- **Kept:** all live briefs, parked (`dead-end-spike-prune`, `cloud-specialist`), QC-pending (`buildings-bake`, `tree-hero-lod`), and **unclear-pending-Jacob** (`p1-frame-enrichment`, `phase2-survey`, `survey-brief`).

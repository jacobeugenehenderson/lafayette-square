...
- **The width-step "dogleg":** `SKELETON §5a/§5g` — a per-fe `pavementHW` step at a through-node, usually a datum-data defect (drop the deviating override), not a construction one.

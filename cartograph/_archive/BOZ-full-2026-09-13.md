...
> **Diary. Retired for CURRENCY, not for TRUTH.** This is `BOZ.md` exactly as it stood at 216 lines on
> 2026-09-13, the day the seat was re-founded. The live charter is `BOZ.md`; it keeps the same section
...
> a rule in `BOZ.md` is questioned — *why does Jacob dispatch? why can't Boz write a probe?* — the instance

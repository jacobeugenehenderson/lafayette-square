...
> `_archive/BRIEF-arborist-exorcism-SUPERSEDED-2026-09-13.md §5` alongside the four more this session found.
...
**You are a fresh agent.** Read `CLAUDE.md` (the gate). Do **not** read `docs/agents/BOZ.md`.

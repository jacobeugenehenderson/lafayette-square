...
> 🗄️ **ARCHIVED 2026-06-14 (doc cleanup).** Closed scope+spike — the cure landed as intersection-everywhere (`9c275ce`); kept as the dated deep-dive record. **Live home: `SKELETON.md §5e`.** (Was `cartograph/JUNCTION-CURE-PLAN.md`.)

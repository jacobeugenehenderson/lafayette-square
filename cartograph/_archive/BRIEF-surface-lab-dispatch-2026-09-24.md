# BRIEF — the surface lab: dispatch text, as written 2026-09-24 (archived 2026-09-25)

> Retired for CURRENCY, not truth. The live brief (`docs/briefs/BRIEF-surface-lab.md`) carries the state; this is the dispatch Boz wrote and Marram built against, with its premises as they stood before measurement.

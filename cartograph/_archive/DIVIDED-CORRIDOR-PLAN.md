...
> 🗄️ **ARCHIVED 2026-06-14 (doc cleanup).** Closed scope+spike — the cure (D1 inner-edge weld + E2 constructed median) landed; kept as the dated deep-dive record. **Live home: `RIBBONS.md §3.1` + `FEATURES.md §367–387`.** (Was `cartograph/DIVIDED-CORRIDOR-PLAN.md`.)

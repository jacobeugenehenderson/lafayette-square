...
| E3.3 / E3.4 (in the plan) | fillet identities — round outer legs only (D3) → datum repair (E1 round 3 + the innerSign vote-flip; Jacob's method call) | queued — Boz drafts each after the prior |

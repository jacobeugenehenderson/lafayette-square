...
| **e3.1-junction-map** | stamp the junction map at prebake (continuity pairs incl. `continuesAs`, de-taper windows, corner identities, apron spec); geometry-neutral (61930d7 pattern). Foundation for E3.2. | NOW — **dispatch-ready** (FRESH) |
| E3.2 / E3.3 / E3.4 (in the plan) | de-taper strokes + aprons (the visible cure) → fillet identities (D3) → datum repair (E1 round 3, Jacob's method call) | queued — Boz drafts each after the prior |

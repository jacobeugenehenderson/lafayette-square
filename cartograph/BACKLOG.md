...
| **osm2streets-grounding** ⭐ | **DISPATCH FIRST.** Specialist grounds our road model in the standard (osm2streets / road-casing / OSM data model) → `OSM2STREETS-GROUNDING.md`. **18th, the marks, and the "loop street" concept all wait on this** — stop inventing; do it the way it's done. The geometric divided-detection (vs data-model) is the suspected root of 18th. | NOW — **dispatch-ready** (FRESH, web access) |

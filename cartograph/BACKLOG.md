...
| E3.4 (in the plan) | datum repair (E1 round 3 + the innerSign vote-flip; **Jacob's method call**: frame-side vs Survey-drag) → fixes the marked curbs #4/#6/#5/#1/#2 | queued — Boz drafts after E3.3 |

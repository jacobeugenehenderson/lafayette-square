...
3. **Suggest, swap, ratify:** for each listed species the kit suggests the best plates by evidence (S > G > T). Jacob swaps any plate and ratifies.
...
- ⛔ **Don't compose or ratify a species on Jacob's behalf** until he rules on the unratified tier. Suggesting is yours; ratifying is his.

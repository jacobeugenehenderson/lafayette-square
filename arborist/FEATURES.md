...
### Salon mode (`src/arborist/SalonWorkstage.jsx`, Brief 1 shipped 2026-05-21; roster-driven nav Brief 26, Cadastre 2026-05-25)
...
- **Gallery** — the by-model 3D crop (per-Look `In Look` / `All Published` scope + tile hover-card). All roster-curation behavior lives here. (Brief 27 retired the Fill/Mid/Hero quality filter — every published composition is Hero, so the filter was inert.)

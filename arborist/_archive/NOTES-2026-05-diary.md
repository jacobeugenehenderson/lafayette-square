# Arborist NOTES — archived diary (May 2026 brief-by-brief record)

> **Archived 2026-06-25** out of `arborist/NOTES.md` per the CLAUDE.md "Keep it trimmed" doctrine — these are the dated session-end records older than ~2 weeks (the May-2026 Salon/Procedural/LiDAR brief arc, 2026-05-14 → 2026-05-26). The live decision record + the recent (2026-06-23 → 2026-06-25) open state stays in `arborist/NOTES.md`; the load-bearing settled doctrine from these entries lives in `FEATURES.md` / `ARCHITECTURE.md`. Verbose, rarely-read, deep-dive-only — nothing here is lost, just cooled.

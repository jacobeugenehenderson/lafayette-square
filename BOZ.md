...
| **Divided roads / carriageways / medians** | **`RIBBONS.md §3.1`** (the live model) · `FEATURES §367–387` (inner-edge anchor, **LOCKED**) · forensics (archived): `cartograph/_archive/DIVIDED-CORRIDOR-PLAN.md` · `cartograph/_archive/TRUMAN-FORENSICS.md` (the parkway knot) | median emergent / E2-constructed; two-carriageway model locked |

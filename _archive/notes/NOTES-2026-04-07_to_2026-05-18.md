# Cartograph NOTES — archive (2026-04-07 → 2026-05-18)

> Diary entries lifted from `cartograph/NOTES.md` on 2026-06-05 to keep the working Diary lean (signal÷volume). **Nothing deleted — moved.** Newest-first (as in NOTES); the legible chronological record for a future forensic reconstruction of what happened and in what sequence. Settled facts have migrated to the Reference docs (SKELETON / PIPELINE / ARCHITECTURE / RIBBONS / FEATURES) — read those for current truth.

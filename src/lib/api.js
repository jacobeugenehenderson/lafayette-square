...
export async function postReview(deviceHash, listingId, text, rating, handle, avatar, vignette, photo) {
  return post('review', { device_hash: deviceHash, listing_id: listingId, business_id: listingId, text, rating, handle: handle || '', avatar: avatar || '', vignette: vignette || '', photo: photo || '' })
}
